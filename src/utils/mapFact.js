...
export function mapSupabaseFact(row, index = 0) {
  ...
  return {
    ...
    glow: catConfig?.glow ?? catTheme?.glow ?? fallback.glow,
    mesh: catConfig?.mesh ?? fallback.mesh,
  };
}
